...
export const coreModules = defineModules([
  ...
  },
  {
    ...
    navigation: { label: "分类任务", sectionId: "governance", order: 10, prefetch: true },
    requiredPermissions: ["documents:write"],
  },
  {
    apiVersion: 1,
    ...
    title: "文件分类审查 / 审查任务",
    subtitle: "跟踪审查进度、查看报告并处理入库",
    navigation: { label: "审查任务", sectionId: "governance", order: 20, prefetch: true },
