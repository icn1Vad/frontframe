...
const navigationSections = [
  ...
  { id: "governance", label: "文件治理", order: 10 },
  { id: "contract-review", label: "合同专项审查", order: 15 },
...
export const coreModules = defineModules([
  ...
  },
  {
    ...
    title: "文件治理 / 文件上传与分类",
    subtitle: "上传、识别并确认文件类型、分类和层级",
    navigation: { label: "文件上传与分类", sectionId: "governance", order: 0, prefetch: true },
  ...
  },
  {
    ...
    title: "文件治理 / 审查任务池",
    subtitle: "承接分类确认后的通用文件审查，跟踪进度、风险报告和入库状态",
    navigation: { label: "审查任务池", sectionId: "governance", order: 20, prefetch: true },
    requiredPermissions: ["reviews:write"],
  },
  {
    apiVersion: 1,
    id: "contractReview",
