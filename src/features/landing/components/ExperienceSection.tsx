...
export function ExperienceSection() {
  return (
    <section
      className="relative flex min-h-[100svh] scroll-mt-24 items-start overflow-hidden border-t border-line/65 px-5 py-24 md:px-8 md:py-28"
      id="experience"
    >
      <div className="paper-noise" />
      <div className="mx-auto flex w-full max-w-[1280px] flex-col">
        <motion.div
          className="landing-experience-grid grid flex-1 gap-10 border-y border-line py-12 lg:grid-cols-2 lg:gap-0"
          initial={{ opacity: 0, y: 22 }}
          transition={{ duration: 0.72, ease: smoothEase }}
          viewport={{ once: true, amount: 0.2 }}
          whileInView={{ opacity: 1, y: 0 }}
        >
          <div className="landing-experience-copy flex flex-col justify-center lg:pr-16">
            <SectionTitle
              className="[&_h2]:text-3xl [&_h2]:leading-tight md:[&_h2]:text-4xl"
              eyebrow="Experience"
              title={
                <>
                  企业文件治理，
          ...
          <div className="landing-auth-column flex items-center justify-center lg:border-l lg:border-line lg:pl-16">
            <LandingAuthPanel />
          </div>
        </motion.div>
