  ...
  return (
    <div className="chat-shell">
      <aside className="chat-list">
        <button className="primary">新建提问集</button>
        {chats.map((chat, index) => (
          <div className={index === 0 ? "selected" : ""} key={chat}>
            <span>{chat}</span>
            {index > 0 ? <Trash2 size={13} /> : null}
          </div>
        ))}
      </aside>
        ...
        <div className="messages">
          ...
          <div className="message">
            ...
            <div>
              ...
              <blockquote>
                <strong>[1]《对外投资管理制度》第 5.1 条</strong>
                <small>单项投资达到集团规定标准的，应履行集团审批程序。</small>
              </blockquote>
              <blockquote>
                <strong>[2]《成员公司投资细则》第 3.2 条</strong>
